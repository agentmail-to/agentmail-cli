...
impl ThreadBuilder {
    ...
    /// - [`inbox_id`](ThreadBuilder::inbox_id)
    /// - [`thread_id`](ThreadBuilder::thread_id)
    /// - [`labels`](ThreadBuilder::labels)
    /// - [`timestamp`](ThreadBuilder::timestamp)
    /// - [`senders`](ThreadBuilder::senders)
    /// - [`recipients`](ThreadBuilder::recipients)
    /// - [`last_message_id`](ThreadBuilder::last_message_id)
