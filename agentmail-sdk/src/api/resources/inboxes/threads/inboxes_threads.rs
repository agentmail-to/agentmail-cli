...
impl ThreadsClient2 {
    ...
    pub async fn list(
        ...
        request: &InboxesThreadsListQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<ListThreadsResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::GET,
                &format!("v0/inboxes/{}/threads", inbox_id.0),
                None,
                QueryBuilder::new()
    ...
    pub async fn search(
        &self,
        inbox_id: &InboxesInboxId,
        request: &InboxesThreadsSearchQueryRequest,
        options: Option<RequestOptions>,
    ) -> Result<SearchThreadsResponse, ApiError> {
        self.http_client
            .execute_request(
                Method::GET,
                &format!("v0/inboxes/{}/threads/search", inbox_id.0),
                None,
                QueryBuilder::new()
        ...
        self.http_client
            .execute_request(
                ...
                &format!(
                    ...
                    inbox_id.0, thread_id.0, attachment_id.0
                ),
                None,
                None,
                options,
